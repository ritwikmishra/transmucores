...
class PairwiseEncoder(torch.nn.Module):
    ...
    def __init__(self, config: Config):
        ...
        self.genre2int = {g: gi for gi, g in enumerate(["bc", "bn", "mz", "nw","pt", "tc", "wb","fu"])} # for all
    ...
    def forward(self,  # type: ignore  # pylint: disable=arguments-differ  #35566 in pytorch
        ...
        genre = torch.tensor(self.genre2int['mu'], device=self.device).expand_as(top_indices)
